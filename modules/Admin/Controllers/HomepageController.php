...
class HomepageController
{
    ...
    public function save(Request $request): Response
    {
        ...
        $pairs = [
            ...
            'home_show_news' => isset($request->body['home_show_news']) ? '1' : '0',
            'home_news_limit' => max(1, min(30, (int)($request->body['home_news_limit'] ?? 6))),
            'home_news_title_ru' => trim($request->body['home_news_title_ru'] ?? ''),
            'home_news_title_en' => trim($request->body['home_news_title_en'] ?? ''),
            'home_news_cta_ru' => trim($request->body['home_news_cta_ru'] ?? ''),
            'home_news_cta_en' => trim($request->body['home_news_cta_en'] ?? ''),
            'home_order_news' => (int)($request->body['home_order_news'] ?? 3),
            'home_order_gallery' => (int)($request->body['home_order_gallery'] ?? 1),
            'home_order_articles' => (int)($request->body['home_order_articles'] ?? 2),
            'home_show_popular_products' => isset($request->body['home_show_popular_products']) ? '1' : '0',
            'home_popular_products_limit' => max(1, min(20, (int)($request->body['home_popular_products_limit'] ?? 4))),
            'home_order_popular_products' => (int)($request->body['home_order_popular_products'] ?? 3),
            'home_popular_products_title_ru' => trim($request->body['home_popular_products_title_ru'] ?? ''),
            'home_popular_products_title_en' => trim($request->body['home_popular_products_title_en'] ?? ''),
            'home_popular_products_cta_ru' => trim($request->body['home_popular_products_cta_ru'] ?? ''),
            'home_popular_products_cta_en' => trim($request->body['home_popular_products_cta_en'] ?? ''),
            ...
            'og_title' => trim($request->body['og_title'] ?? ''),
            'og_description' => trim($request->body['og_description'] ?? ''),
            'og_image' => trim($request->body['og_image'] ?? ''),
            'home_page_title_ru' => trim($request->body['home_page_title_ru'] ?? ''),
            'home_page_title_en' => trim($request->body['home_page_title_en'] ?? ''),
            'home_page_description_ru' => trim($request->body['home_page_description_ru'] ?? ''),
            'home_page_description_en' => trim($request->body['home_page_description_en'] ?? ''),
        ];
