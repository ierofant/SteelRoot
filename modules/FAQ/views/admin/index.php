        ...
        <?php foreach ($items as $item): ?>
            <tr>
                ...
                <td class="actions">
                    ...
                    <form method="post" action="<?= htmlspecialchars((defined('ADMIN_PREFIX') ? ADMIN_PREFIX : '/admin') . '/faq/delete/' . (int)($item['id'] ?? 0)) ?>" onsubmit="return confirm('Delete item?')" class="module-action-form">
