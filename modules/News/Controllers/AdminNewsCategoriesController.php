...
class AdminNewsCategoriesController
{
    ...
    public function __construct(Container $container)
    {
        ...
        $this->service = new NewsCategoryService($container->get(Database::class));
        $this->uploadPath = APP_ROOT . '/storage/uploads/news/categories';
    ...
    public function index(Request $request): Response
    {
        ...
        $html = $this->container->get('renderer')->render('news/admin/categories', [
            'title'      => 'News Categories',
            'mode'       => 'list',
            'categories' => $categories,
            'csrf'       => Csrf::token('news_admin'),
    ...
    {
        if (!Csrf::check('news_admin', $request->body['_token'] ?? null)) {
        ...
        return new Response('', 302, ['Location' => $prefix . '/news/categories']);
    }
